...
export function BenchmarkGrid() {
  ...
  return (
    <section id="benchmarks" className="w-full max-w-7xl mx-auto my-16 px-4">
      ...
      <div className="mt-12 p-6 bg-gradient-to-r from-black via-[#0A0A0A] to-[#00C8FF]/10 border border-white/10 rounded-2xl flex flex-col sm:flex-row items-center justify-between gap-4">
        ...
        <div className="flex items-center gap-6 font-mono text-center sm:text-right">
          ...
          <div>
            <span className="text-base font-bold text-[#00C8FF]">100%</span>
