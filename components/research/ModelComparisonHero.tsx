  ...
  return (
    <div className="w-full max-w-6xl mx-auto mb-16">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mt-8">
        {/* Titan Pro Thinking - rgb(244, 243, 239) Warm Cream */}
        <motion.div
          whileHover={{ y: -4 }}
          transition={{ duration: 0.2 }}
          className="relative bg-gradient-to-b from-[#141414] to-[#0A0A0A] border border-[#F4F3EF]/30 rounded-3xl p-6 sm:p-8 shadow-2xl flex flex-col justify-between overflow-hidden"
        >
          <div className="absolute top-0 right-0 w-64 h-64 bg-[#F4F3EF]/10 rounded-full blur-3xl pointer-events-none" />

          <div>
            <div className="flex items-center justify-between mb-4">
              <div className="flex items-center gap-2.5">
                <div className="w-9 h-9 rounded-2xl bg-[#F4F3EF]/10 border border-[#F4F3EF]/30 flex items-center justify-center">
                  <TitanLogo className="w-6 h-5 text-[#F4F3EF]" />
                </div>
                <div>
                  <h3 className="text-xl font-bold text-white tracking-tight">Zero Titan Pro Thinking</h3>
                  <span className="text-[11px] font-mono text-[#F4F3EF]">High-Efficiency Agentic Engine by Zero</span>
                </div>
              </div>
              <span className="px-2.5 py-1 rounded-full bg-[#F4F3EF]/10 border border-[#F4F3EF]/30 text-[#F4F3EF] text-[10px] font-mono font-bold">
                ZERO PRO TIER
              </span>
            </div>
            ...
            <div className="grid grid-cols-2 gap-3 mb-6 font-mono text-xs">
              ...
              <div className="p-3 rounded-xl bg-white/[0.03] border border-white/5">
                ...
                <span className="text-[#F4F3EF] font-bold">Self-Verified CoT</span>
              </div>
              <div className="p-3 rounded-xl bg-white/[0.03] border border-white/5">
                <span className="text-white/40 text-[10px] block mb-1">SWE-bench Verified</span>
                <span className="text-[#F4F3EF] font-bold">73.1% Resolved</span>
              </div>
              <div className="p-3 rounded-xl bg-white/[0.03] border border-white/5">
                <span className="text-white/40 text-[10px] block mb-1">AIME 2026 Score</span>
                <span className="text-[#F4F3EF] font-bold">83.8% Pass@1</span>
              </div>
            </div>
          </div>
          ...
          <div className="pt-4 border-t border-white/10 flex items-center justify-between text-xs text-white/50">
            <span className="flex items-center gap-1.5">
              <Zap className="w-3.5 h-3.5 text-[#F4F3EF]" />
              Sub-30ms Time to First Token
            </span>
            <span className="text-[#F4F3EF] font-mono font-semibold">Active in Zero Chat</span>
          </div>
        </motion.div>

        {/* Titan Ultra Thinking - rgb(0, 200, 255) Electric Cyan */}
        <motion.div
          whileHover={{ y: -4 }}
          transition={{ duration: 0.2 }}
